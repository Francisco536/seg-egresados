        ...
        <div class="card-body">
            <div class="container">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nombre" type="text" class="tab1 form-control" name="nombre" value="{{ old('nombre') }}" required placeholder="Apellido paterno         Apellido materno        Nombre(s)" autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="fecha_nacimiento" type="date" class="tab1 form-control" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" required placeholder="dd/mm/yyyy" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="curp" type="text" class="tab1 form-control " name="curp" required autocomplete="curp" autofocus pattern="/^([A-ZÑ][AEIOUXÁÉÍÓÚ][A-ZÑ]{2}\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])[HM](?:AS|B[CS]|C[CLMSH]|D[FG]|G[TR]|HG|JC|M[CNS]|N[ETL]|OC|PL|Q[TR]|S[PLR]|T[CSL]|VZ|YN|ZS)[B-DF-HJ-NP-TV-Z]{3}[A-Z\d])(\d)$/">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="domicilio" type="text" class="tab1 form-control" name="domicilio" value="{{ old('domicilio') }}" required placeholder="Calle              No.               Colonia                 C.P."  autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="ciudad" type="text" class="tab1 form-control" name="ciudad" value="{{ old('ciudad') }}" required  autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="municipio" type="text" class="tab1 form-control" name="municipio" value="{{ old('municipio') }}" required autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="estado" type="text" class="tab1 form-control" name="estado" value="{{ old('estado') }}" required autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="telefono" type="text" class="tab1 form-control" name="telefono" value="{{ old('telefono') }}" required placeholder="952 837 2881" regex="/[0-9]{10}/" autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="email" type="email" class="tab1 form-control" name="email" value="{{ old('email') }}" required autocomplete="email">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="especialidad" type="text" class="tab1 form-control" name="especialidad" value="{{ old('especialidad') }}" required autocomplete="especialidad" autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="mes_egreso" type="text" class="tab1 form-control" name="mes_egreso" value="{{ old('mes_egreso') }}" required placeholder="Enero" autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="anio_egreso" type="text" class="tab1 form-control" name="anio_egreso" value="{{ old('anio_egreso') }}" required placeholder="2022" autofocus>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="ingles" type="text" class="tab1 form-control" name="ingles" required placeholder="75 %">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="manejo_paquetes" type="text" class="tab1 form-control" name="manejo_paquetes" required >
                    </div>
                </div>
                <br><br>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="especialidad_estud">Especialidad e institución: </label>
                            <input type="text" name="especialidad_estud" class="form-control">
                        </div>
                    ...
                    <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mb-3">
                                ...
                                <input id="direccion" type="text" class="col-md-6 form-control" name="direccion" value="{{ old('domicilio') }}" required placeholder="Calle              No.               Colonia                 C.P."  autofocus>
                            </div>


                                <div class="row mb-3">
                                <label for="ciudad_emp" class="col-md-4 col-form-label text-md-end">{{ __('Ciudad') }}</label>
                                <input id="ciudad_emp" type="text" class="col-md-6 form-control " name="ciudad_emp" value="{{ old('ciudad') }}" required  placeholder="Ciudad" autofocus>
                                </div>


                            <div class="row mb-3">
                                <label for="municipio_emp" class="col-md-4 col-form-label text-md-end">{{ __('Municipio') }}</label>
                                <input id="municipio_emp" type="text" class="col-md-6 form-control" name="municipio_emp" value="{{ old('municipio') }}" required placeholder="Municipio" autofocus>
                            </div>

                            <div class="row mb-3">
                                <label for="estado_emp" class="col-md-4 col-form-label text-md-end">{{ __('Estado') }}</label>
                                <input id="estado_emp" type="text" class="col-md-6 form-control" name="estado_emp" value="{{ old('estado') }}" required placeholder="Estado" autofocus>
                            </div>

                            <div class="row mb-3">
                                <label for="telefono_emp" class="col-md-4 col-form-label text-md-end">{{ __('Telefono') }}</label>
                                    <input id="telefono_emp" type="text" class="col-md-6 form-control" name="telefono_emp" value="{{ old('telefono') }}" required placeholder="952 837 2881" autofocus>
                            </div>

                            <div class="row mb-3">
                                <label for="email_emp" class="col-md-4 col-form-label text-md-end">{{ __('Correo') }}</label>
                                <input id="email_emp" type="email" class="col-md-6 form-control" name="email_emp" value="{{ old('email') }}" required placeholder="example@gmail.com" autocomplete="email">
                            </div
